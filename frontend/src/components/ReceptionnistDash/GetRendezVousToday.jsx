...
//     if (s.includes("Planif")) return "bg-primary";
//     return "bg-secondary";
//   };
...
//           `${API_BASE_URL}/api/receptionniste/rendezVous/aujourdhui`,
//           {
//             headers: {
...
//     { value: "Planifié", label: "Planifié", badge: "bg-primary text-dark" },
//     // { value: "Confirmé", label: "Confirmé", badge: "bg-success" },
...
// import "./rdv-cards-today.css"; // <-- ton CSS
...
//                           <strong>Patient :</strong> Khalid Youssef
//                         </div>
//                       </div>
...
//         </div>
//       </div>
//       {/* ✅ Le modal (formulaire) est monté ici */}
//       {showCreate && (
//         <CreateRv
//           show={showCreate}
//           onClose={() => setShowCreate(false)}
//           onSuccess={() => {
//             // après création, on rafraîchit la liste du jour
//             fetchRendezVous();
//           }}
//         />
//       )}
...
// function GetRendezVousToday({ onCountChange }) {
//   const [rendezVous, setRendezVous] = useState([]);
//   const [isLoading, setIsLoading] = useState(false);
//   const [error, setError] = useState(null);
//   const [updatingId, setUpdatingId] = useState(null);
...
//     if (s.includes("annul") || s.includes("refus")) return "bg-danger";
//     if (s.includes("attente") || s.includes("pending") || s.includes("en_attente"))
//       return "bg-warning text-dark";
...
//         // dédoublonner (si l’API renvoie des doublons)
...
//         // garder uniquement >= now et trier croissant
//         const now = new Date();
...
//   // ⬇️ Adapter selon l’enum backend réceptionniste
//   const STATUS_OPTIONS = [
...
//   // Ouvre/ferme via l’API JS (pas de data-bs-toggle)
...
//                   return (
//                     <div
//                       key={rv.id ?? `${rv.date}-${rv.heure}-${patientLabel(rv)}`}
//                       className="rdv-card border rounded-3 p-3 d-flex flex-column flex-md-row align-items-stretch"
//                     >
//                       {/* Date */}
//                       <div className="rdv-datebox me-md-3 mb-3 mb-md-0 d-flex flex-column justify-content-center align-items-center">
...
//                             disabled={updatingId === rv.id}
//                           >
//                             {updatingId === rv.id ? "Mise à jour..." : "Modifier statut"}
//                           </button>
...
//                                     className="dropdown-item d-flex align-items-center gap-2"
//                                     onClick={() =>
//                                       handleChangeStatus(rv.id, opt.value, toggleId)
//                                     }
//                                     disabled={isCurrent || updatingId === rv.id}
//                                   >
//                                     {isCurrent ? (
...
//                                     )}
//                                     <span>{opt.label}</span>
//                                     <span className={`badge ms-auto ${opt.badge}`}>
//                                       {opt.label}
//                                     </span>
//                                   </button>
//                                 </li>
...
// GetRendezVousToday.jsx
// import React, { useState, useEffect, useCallback } from "react";
// import { useNavigate } from "react-router-dom";
// import API_BASE_URL from "../../config/apiConfig";
// import "./rdv-cards-today.css";
// import "bootstrap/dist/js/bootstrap.bundle.min.js";
// import "bootstrap-icons/font/bootstrap-icons.css";
// import CreateRv from "../CreateRendezVous/CreateRv";
// // (Si ton chemin réel diffère, adapte l'import)
...
//   const parseRvDateTime = (rv) => { /* ... inchangé ... */ };
//   const fmtParts = (rv) => { /* ... inchangé ... */ };
//   const statusBadge = (status) => { /* ... inchangé ... */ };
//   const medecinLabel = (rv) => { /* ... inchangé ... */ };

//   // ✅ on sort la fonction pour pouvoir la rappeler
//   const fetchRendezVous = useCallback(async () => {
//     const token = localStorage.getItem("token");
//     if (!token) {
//       navigate("/login");
...
//     setError(null);
//     try {
//       const res = await fetch(`${API_BASE_URL}/api/receptionniste/rendezVous/aujourdhui`, {
...
//   const STATUS_OPTIONS = [ /* ... inchangé ... */ ];
//   const getMeta = (v) => STATUS_OPTIONS.find((o) => o.value === String(v || ""));
//   const handleChangeStatus = async (id, newStatus) => { /* ... inchangé ... */ };

//   return (
//     <div className="container py-3">
//       <div className="rdv-list border rounded-4 shadow-sm overflow-hidden card-rv">
//         <div className="rdv-list-header px-3 py-2">
//           <h5 className="m-0 fw-semibold text-secondary">Les rendezVous d'aujourd'hui</h5>
//         </div>
...
//             <div className="text-center py-4">Chargement…</div>
//           ) : rendezVous.length === 0 ? (
//             <div className="text-center text-muted py-4">Aucun rendez-vous aujourd'hui</div>
//           ) : (
//             <div className="rdv-scroll">
//               {/* ... cartes inchangées ... */}
//             </div>
...
//         {/* Pied avec le bouton d'ouverture du modal */}
//         <div className="rdv-list-footer text-center border-top p-3">
//           <button
//             className="btn btn-outline-secondary fw-semibold"
//             onClick={() => setShowCreate(true)}        // ✅ au lieu de navigate("newRV")
//           >
//             <i className="bi bi-plus-circle me-1"></i> Ajouter RendezVous
//           </button>
//         </div>
